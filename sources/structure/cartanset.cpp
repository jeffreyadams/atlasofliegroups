...
{
  canonicalize(sigma);
  return std::find(&d_twistedInvolution[0],&*d_twistedInvolution.end(),sigma)
                 - &d_twistedInvolution[0];
}
  ...
  const
{
  ...
  return std::find(&d_twistedInvolution[0],&*d_twistedInvolution.end(),ti)
                  -&d_twistedInvolution[0];
}
...
/*****************************************************************************
        ...
        Chapter III --- Functions declared in cartanset.h
			   ...
			   const weyl::WeylGroup& W)
{
  ...
  WeylWord wi; W.involutionOut(wi,ti);
