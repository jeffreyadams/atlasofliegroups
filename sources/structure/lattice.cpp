...
namespace atlas {
  ...
  what is defined in latticetypes.cpp.  It includes change of basis
  functions, reduction modulo two, and calculating the orthogonal of a
  sublattice.  
  */
namespace lattice {
...
/*!
  ...
  generated by b2. The algorithm is simple : find a Smith normal basis
...

{
  ...
  std::vector<LatticeCoeff> inv_factor;
  WeightList sb;
  initBasis(sb,r);
