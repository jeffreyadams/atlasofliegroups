...
def atlas_compute(i,pid):
   ...
   log.write("Computing FPP3 for " + group + "\n")
...
#      atlas_arg_txt="set list=FPP(" + group + "," + str(x) + "," + test_function + ")" + "\n"
      atlas_arg_txt="set list=FPP3(" + group + "," + str(x) + "," + test_function + ",unitary_hash)" + "\n"
